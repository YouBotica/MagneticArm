...
class PositionActionClient(Node):

    def __init__(self):
        super().__init__('position_actionclient')
    ...
    def send_goal(self, angle):
        ...
        point2.positions = [angle, angle, angle, angle, angle, angle]
...
def main(args=None):
    ...
    action_client = PositionActionClient()
